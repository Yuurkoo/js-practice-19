...
console.log(Book.isPrototypeOf(prot));
...
Textbook.read = function () {
  return `Ви читайєте підручник "${Textbook.title}" від ${Textbook.author}.  ${Textbook.info}`;
};
...
const Media = {
  ...
  length: 0,
  play() {
    return `Зараз відтворюється медіа у форматі ${Media.format} з тривалістю ${Media.length} секунд`;
  },
};
